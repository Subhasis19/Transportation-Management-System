...
const emptyForm = (): VehicleForm => ({ vehicle: null, regNumber: "", vehicleType: "MINI_TRUCK", capacityKg: "", rcNumber: "", rcExpiry: "", permitNumber: "", permitExpiry: "" });
